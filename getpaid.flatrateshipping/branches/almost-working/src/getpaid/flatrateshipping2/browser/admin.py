...
class FlatRateSettings( EditFormViewlet ):
    
    form_name = _(u"Flat Rate Shipping Settings")
    form_description = _(u"Configuration of Flat Rate Shipping Shipping")
    form_fields = form.Fields( interfaces.IFlatRateSettings )
    prefix = "flaterate"
    
    def setUpWidgets( self, ignore_request=False ):
        self.adapters = { interfaces.IFlatRateSettings : component.getUtility( interfaces.IShippingRateService, name="flatrate") }

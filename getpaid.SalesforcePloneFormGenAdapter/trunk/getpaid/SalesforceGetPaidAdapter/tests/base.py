...
class SalesforceGetPaidAdapterTestCase(ptc.PloneTestCase):
    """Base class for integration tests for the 'SalesforceGetPaidAdapter' product. This may
    provide specific set-up and tear-down operations, or provide convenience
    methods.
    """

class BaseSalesforceGetPaidAdapterFunctionalTestCase(PloneGetPaidFunctionalTestCase):

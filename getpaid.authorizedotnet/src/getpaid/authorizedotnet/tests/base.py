...
def setup_product():
    ...
    import getpaid.core
    zcml.load_config('configure.zcml', getpaid.core)
    ...
    ztc.installPackage('getpaid.core')
    ztc.installPackage('getpaid.authorizedotnet')
...
class GPADNTestCase(ptc.PloneTestCase):
    """We use this base class for all the tests in this package. If necessary,
    we can put common utility or setup code in here. This applies to unit
    test cases.
    """

class GPADNFunctionalTestCase(ptc.FunctionalTestCase):

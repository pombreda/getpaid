...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        portlet = getUtility(IPortletType, name='getpaid.variantsproduct.portlets.VariantProductShopper')
        self.assertEquals(portlet.addview, 'getpaid.variantsproduct.portlets.VariantProductShopper')

...
def setup_product():
    ...
    import getpaid.couponcode
    zcml.load_config('configure.zcml', getpaid.couponcode)
    ...
    ztc.installPackage('getpaid.couponcode')
...
setup_product()
ptc.setupPloneSite(products=['getpaid.couponcode'])

...
products installed.
(again stolen from PloneGetPaid)
"""
...
# We take this info from PGP since we are going to depend on it anyway
...
class GetPaidFormGenPaidTestCase(PloneTestCase):
    ...
    def afterSetUp( self ):
        ...
        self.portal.portal_quickinstaller.installProduct('PloneFormGen')
        self.portal.portal_quickinstaller.installProduct('getpaid.formgen')
        
        
class GetPaidFormGenFunctionalTestCase(FunctionalTestCase):
    """Base class for functional integration tests for the 'getpaid.formgen' product. 

...
class IRecurrentPaymentMarker( IPayableMarker ):
    """ IRecurrentPayment interface added to IRecurrentPayment content """
...
PayableMarkers = [ IBuyableMarker, IPremiumMarker, IShippableMarker, IDonatableMarker, IRecurrentPaymentMarker ]
...
PayableMarkerMap = dict(
     (
      ...
      (IRecurrentPaymentMarker, igetpaid.IRecurrentPaymentContent)
    )
)

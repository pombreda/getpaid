...
from Products.PloneGetPaid.interfaces import IGetPaidManagementOptions, IAddressBookUtility, ICreateTransientOrder
...
class CreateTransientOrder( object ):
    ...
    def __call__(self):
        ...
        shopping_cart = component.getUtility( interfaces.IShoppingCartUtility ).get( self.wizard.context )

...
class GetpaidClickAndBuyThankyouView(BrowserView):
    """Class for overriding getpaid-thank-you view for clickandbuy purchases
    """
    ...
    def success(self):
        ...
        if self.request.get('result') == 'success':
            ...
            client = Client('http://wsdl.uk.clickandbuy.com/TMI/1.4/TransactionManagerbinding.wsdl')
